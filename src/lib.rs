...
pub fn run(task_list: &mut TaskList) -> Result<(), Box<dyn Error>> {
...
pub fn select_mode() -> Result<Mode, Box<dyn Error>> {
...
impl TaskList {
    ...
    pub fn add_task_prompt(&mut self) -> Result<(), Box<dyn Error>> { 
        loop {
            self.print_tasks();
    ...
    pub fn remove_task(&mut self) -> Result<(), Box<dyn Error>> {
